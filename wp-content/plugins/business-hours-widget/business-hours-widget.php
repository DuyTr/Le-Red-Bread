 ...
 * @author    Duy Tran <duytran02@gmail.com>
 * @license   GPL-2.0+
 * @link      http://redacademy.com
 * @copyright 2015 Le Red Bread Bakery
 * @wordpress-plugin
 * Plugin Name:       Le Readb Bread Business Hourse Widget
 * Plugin URI:        http[://redacademy.com
 * Description:       A business hour widit for Le Red Bread
 * Version:           1.0.0
 * Author:            Duy Tran
 * Author URI:        @http://redadacmy.com
 * License:           GPL-2.0+
...
class LRB_Business_Hours extends WP_Widget {
    ...
    /**
     * @TODO - Rename "LRB-Busines-Hours" to the name your your widget
     *
     ...
     * @var      string
     */
    protected $widget_slug = 'LRB-Busines-Hours';
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => 'A little business hours widget'
			)
		);
